...
end, {description = "Hota_Repo: Suspend when laptop lid is closed"})
hl.bind("switch:off:Lid Switch", function()
    hl.exec_cmd("qs -c ii ipc call lidSwitch resume")
end, {description = "Hota_Repo: Resume when laptop lid is opened"})

--##! Task View - Super+Tab
hl.unbind("SUPER + Tab")
hl.bind("SUPER + Tab", hl.dsp.global("quickshell:taskViewToggle"), {description = "Hota_Repo: Toggle task view"})